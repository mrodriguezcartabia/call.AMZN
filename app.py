...
texts = {
    "en": {
        ...
        "error_fred": "No connection to FRED",
        "parar_precio": "Error connecting to Alpha Vantage. Please refresh the page. If it still doesn't work, enter the price manually:",
    ...
    "es": {
        ...
        "parar_precio": "Error al conectar con Alpha Vantage. Actualice la página. Si sigue sin funcionar, introduzca el precio manualmente:",
    ...
    "pt": {
        ...
        "error_fred": "Sem conexão com a FRED",
        "parar_precio": "Erro ao conectar-se à Alpha Vantage. Atualize a página. Se o problema persistir, insira o preço manualmente:",
